...
export default function Login({
  ...
  return (
    <form className="animate-in flex-1 flex flex-col w-full min-h-[40vh] justify-center items-center gap-2 text-foreground">
      <Image src={'/dinedash-transparent.png'} width={1920} height={1080} alt="Logo" className="w-1/2 sm:w-1/4 h-full border-2 rounded-full" />
      <p className="text-3xl font-funky m-2 decor orange">Welcome to Dinedash</p>
